"""
Scenario 8: Build Unanimous-Agreement Demographics-Only Dataset (Same Split)
=============================================================================
Keeps the exact patient split from scenario 9
(processed_data_unanimous_with_demographics_same_split), but retains only
demographic features for model input.

Output:
  processed_data_unanimous_demographics_only_same_split/

Run: python 03i_build_unanimous_demo_only_same_split.py
"""
...
SOURCE_DIR = "processed_data_unanimous_with_demographics_same_split"
OUTPUT_DIR = "processed_data_unanimous_demographics_only_same_split"

DEMO_FEATURES = ["patient_age_years", "sex_binary", "weight", "height", "BMI"]
ID_COLS = ["Anonymize_ID", "hip_side", "Cohort_group"]
GT_COLS = ["gt_unanimous"]
...
def main():
    ...
    meta_out = {
        **source_meta,
        "analysis_variant": "scenario8_unanimous_demographics_only",
        "feature_columns": DEMO_FEATURES,
        "demographic_feature_columns": DEMO_FEATURES,
        "ct_feature_columns": [],
        "notes": "Same row split as processed_data_unanimous_ct_only; demographics-only feature set.",
    }
